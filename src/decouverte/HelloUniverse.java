...
import decouverte.enginspatio.CivilSpaceship;
import decouverte.enginspatio.Spaceship;

import static decouverte.enginspatio.TypeSpaceShip.CARGO;
import static decouverte.enginspatio.TypeSpaceShip.VAISSEAU_MONDE;
import static decouverte.enginspatio.TypeSpaceShip.CHASSEUR;
import static decouverte.enginspatio.TypeSpaceShip.FREGATE;
import static decouverte.enginspatio.TypeSpaceShip.CROISEUR;

import decouverte.enginspatio.TypeSpaceShip;
import decouverte.enginspatio.WarSpaceship;
import decouverte.objetastro.*;
...
//        System.out.println("----------------------------- chap5 tp final classe abstraite --------------------------------------");
        ...
        WarSpaceship chasseurC = new WarSpaceship(CHASSEUR, 20, 100, 12);
        WarSpaceship fregateC = new WarSpaceship(FREGATE, 30, 150, 2);
        WarSpaceship croiseurC = new WarSpaceship(CROISEUR, 35, 200, 22);
        CivilSpaceship cargoC = new CivilSpaceship(CARGO, 200, 1000, 100);
        CivilSpaceship vaisseauMondeC = new CivilSpaceship(VAISSEAU_MONDE, 300, 2000, 500);
...
//        terre.welcomeSpaceships(cargoC, chasseurC, croiseurC, fregateC);
        ...
        while (true) {
            ...
            System.out.println("Quel vaisseau souhaitez-vous manipuler: " + CHASSEUR.name + ", Frégate, Croiseur, Cargo et Vaisseau-Monde");
